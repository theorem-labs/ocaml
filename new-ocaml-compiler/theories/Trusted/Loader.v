(* Loader.v - [TRUSTED] Bytecode decoder.
   Ports the decoding logic from test/harness/loader.ml to Rocq.
...
(* A section entry: 4-char name encoded as a Z (big-endian u32), offset, length. *)
Record section : Type := mk_section {
  sec_name   : Z;     (* 4 bytes packed as big-endian u32 *)
  sec_offset : nat;
  sec_length : nat;
}.
