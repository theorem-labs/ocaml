...
Theorem verify_PUSHACC5_correct :
    handler_correct (handle_instr (PUSHACC 5)) (clight_of (PUSHACC 5))
      (error_message_of (PUSHACC 5))
      (pre_of (PUSHACC 5)) (P_halt_of (PUSHACC 5)) (P_ccall_of (PUSHACC 5)).
Proof.
Admitted.

Definition correct_PUSHACC5 :
    handler_correct (handle_instr (PUSHACC 5)) (clight_of (PUSHACC 5))
      (error_message_of (PUSHACC 5))
      (pre_of (PUSHACC 5)) (P_halt_of (PUSHACC 5)) (P_ccall_of (PUSHACC 5)).
Proof. exact verify_PUSHACC5_correct. Qed.
