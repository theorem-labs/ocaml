...
Theorem verify_PUSHACC5_correct :
    handler_correct_v1 (handle_PUSHACC 5) f_instr_PUSHACC5
      (fun _ m _ ard =>
...
Proof.
  ...
  (* Pre-compute ptrofs_add_unsigned before ltac:() side effects *)
  rewrite Hstk in Hsp_rep. simpl length in Hsp_rep.
  assert (Hsp_add32 : Ptrofs.unsigned (Ptrofs.add sp_ofs (Ptrofs.repr 32)) = Ptrofs.unsigned sp_ofs + 32).
  ...
  destruct (store_succeeds_sb m2 sb so 8 accu_v Hsb_writable_m2 Haccu_load_m2 ltac:(lia) ltac:(lia) cv4)
