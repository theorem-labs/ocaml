...
Theorem verify_PUSHACC4_correct :
    handler_correct_v1 (handle_PUSHACC 4) f_instr_PUSHACC4
      (fun _ m _ ard =>
...
Proof.
  ...
  assert (Hstack_m1 : stack_repr hm cb co m1 (v0 :: v1 :: v2 :: v3 :: rest) sp_b sp_ofs).
  ...
  assert (Hstack_m2 : stack_repr hm cb co m2 (Machine.accu s :: v0 :: v1 :: v2 :: v3 :: rest) sp_b new_sp_ofs).
  ...
  (* ============================================================== *)
  {
    ...
    try rewrite (sem_cast_long_val_repr _ _ _ _ _ _ Hval_b3); eval_cbn.
  ...
  (* ============================================================== *)
  {
    ...
    { pose proof (load_after_store_same m2 m3 sb (uso + 8) cxb3 Hstore_accu_field) as Htmp.
      rewrite (val_repr_load_result hm cb co v3 cxb3 Hval_b3) in Htmp.
      exact Htmp. }
