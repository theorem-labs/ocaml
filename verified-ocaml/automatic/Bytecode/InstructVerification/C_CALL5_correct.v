(* C_CALL5_correct.v -- C_CALL5 handler completeness proof.

   The C body advances pc by 1 and returns 3 (CCall_request signal).
   The Rocq handler is: handle_C_CALL 5 prim_idx pc' s = CCall_request ...
...
Theorem verify_C_CALL5_correct : forall prim_idx,
  handler_correct_v1 (handle_C_CALL 5 prim_idx) f_instr_C_CALL5
    (fun _ _ _ _ => True)
