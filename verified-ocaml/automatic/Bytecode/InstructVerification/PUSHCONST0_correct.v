...
Proof.
  ...
  destruct (store_succeeds_sb m2 sb so 8 accu_v Hsb_writable_m2 Haccu_load_m2 ltac:(lia) ltac:(lia) (Vlong (Int64.repr 1))) as [m3 Hstore_const].
