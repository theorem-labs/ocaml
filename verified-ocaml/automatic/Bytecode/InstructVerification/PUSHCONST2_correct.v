...
Theorem verify_PUSHCONST2_correct :
    handler_correct_v1 (handle_PUSHCONSTINT 2) f_instr_PUSHCONST2
      (fun _ m _ ard =>
...
Proof.
  ...
  destruct (store_succeeds_sb m2 sb so 8 accu_v Hsb_writable_m2 Haccu_load_m2 ltac:(lia) ltac:(lia) (Vlong (Int64.repr 5))) as [m3 Hstore_const].
