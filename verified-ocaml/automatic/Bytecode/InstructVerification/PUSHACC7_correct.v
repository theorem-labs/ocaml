...
Theorem verify_PUSHACC7_correct :
    handler_correct_v1 (handle_PUSHACC 7) f_instr_PUSHACC7
      (fun _ m _ ard =>
...
Proof.
  ...
  assert (Hsp_add48 : Ptrofs.unsigned (Ptrofs.add sp_ofs (Ptrofs.repr 48)) = Ptrofs.unsigned sp_ofs + 48).
  ...
  destruct (store_succeeds_sb m2 sb so 8 accu_v Hsb_writable_m2 Haccu_load_m2 ltac:(lia) ltac:(lia) cv6)
  ...
  (* ============================================================== *)
  {
    ...
    try rewrite (sem_cast_long_val_repr _ _ _ _ _ _ Hval_repr6); eval_cbn.
  ...
  (* ============================================================== *)
  {
    ...
    { pose proof (load_after_store_same m2 m3 sb (uso + 8) cv6 Hstore_accu_field) as Htmp.
      rewrite (val_repr_load_result hm cb co v6 cv6 Hval_repr6) in Htmp.
      exact Htmp. }
    ...
    { exists (Vptr sp_b new_sp_ofs), sp_b, new_sp_ofs.
      assert (Hstack_m1 : stack_repr hm cb co m1 (v0 :: v1 :: v2 :: v3 :: v4 :: v5 :: v6 :: rest) sp_b sp_ofs).
      { apply (stack_repr_store_other_block hm cb co m m1 _ sp_b sp_ofs sb
                 (uso + 16) (Vptr sp_b new_sp_ofs)
                 Hstack_repr Hstore_sp).
        intro Heq; exact (Hsp_ne_sb (eq_sym Heq)). }
      assert (Hstack_m2 : stack_repr hm cb co m2 (Machine.accu s :: v0 :: v1 :: v2 :: v3 :: v4 :: v5 :: v6 :: rest) sp_b new_sp_ofs).
      ...
      assert (Hstack_m3 : stack_repr hm cb co m3 (Machine.accu s :: v0 :: v1 :: v2 :: v3 :: v4 :: v5 :: v6 :: rest) sp_b new_sp_ofs).
