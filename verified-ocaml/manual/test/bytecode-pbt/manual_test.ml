...
let () =
  ...
  let result = run_pure 100 (Array.of_list code) [] in
  (match result with
  ...
  let result2 = run_pure 100 (Array.of_list code2) [] in
  (match result2 with
  ...
  let result4 = run_pure 100 (Array.of_list code4) [Val_int 0] in
  (match result4 with
  ...
  let result5 = run_pure 100 (Array.of_list code5) [] in
  (match result5 with
