...
Definition pushenvacc_step_pre_4 (e : Clight.env) (m : mem) (s : Machine.state)
  ...
  exists sp_b sp_ofs,
    ...
    (forall v,
      ...
      forall env_v,
        ...
        exists b ofs cv,
          env_v = Vptr b ofs /\
          Mem.load Mint64 m b (Ptrofs.unsigned (Ptrofs.add ofs (Ptrofs.repr 32))) = Some cv /\
          val_repr hm v cv /\
          b <> sb /\ b <> sp_b).

Theorem verify_PUSHENVACC4_correct :
    handler_correct (handle_PUSHENVACC 4) f_instr_PUSHENVACC4
      pushenvacc_step_pre_4
...
Proof.
  ...
  2: { reflexivity. }
  {
    ...
    unfold pushenvacc_step_pre_4 in Hstep_pre. fold sb so hm in Hstep_pre.
