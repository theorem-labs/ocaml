          ...
          { (* Sset _t'2 ; (Sset _t'3 ; Sifthenelse) *)
            ...
            { (* Sset _t'3 ; Sifthenelse *)
              ...
              { (* Sifthenelse: unsigned comparison true => then branch *)
                ...
                { (* Eval condition: (unsigned long)_t'2 < (unsigned long)(_t'3 >> 1) *)
                  eapply eval_Ebinop.
                  - eapply eval_Ecast.
                  ...
                  - apply (bultint_cmp_true n a m1 Hn_nonneg Hn_range Haccu_range Hcmp). }
                ...
                { eapply eval_Ebinop.
                  ...
                  - eapply eval_Ecast.
                    + eapply eval_Ebinop.
                      ...
                      * apply sem_shr_long_int_1.
                    + apply sem_cast_long_to_ulong.
                  - apply (bultint_cmp_false n a m1 Hn_nonneg Hn_range Haccu_range Hcmp). }
                { apply bool_val_of_bool. }
                { simpl.
