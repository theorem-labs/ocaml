...
Proof.
  ...
  assert (Hstack_m1 : stack_repr hm m1 (v0 :: v1 :: v2 :: rest) sp_b sp_ofs).
  ...
  assert (Hstack_m2 : stack_repr hm m2 (Machine.accu s :: v0 :: v1 :: v2 :: rest) sp_b new_sp_ofs).
  ...
  destruct (store_succeeds_from_load m2 sb (Ptrofs.unsigned so + 8) accu_v cxb2
  ...
  (* ============================================================== *)
  {
    ...
    try rewrite (sem_cast_long_val_repr _ _ _ _ Hval_b2); eval_cbn.
  ...
  (* ============================================================== *)
  {
    ...
    { pose proof (load_after_store_same m2 m3 sb (uso + 8) cxb2 Hstore_accu_field) as Htmp.
      rewrite (val_repr_load_result hm v2 cxb2 Hval_b2) in Htmp.
      exact Htmp. }
    ...
    { exists (Vptr sp_b new_sp_ofs), sp_b, new_sp_ofs.
      ...
      - exact Hsp_ne_gb.
      - exact Hcb_ne_sp.
      - apply (sp_ofs_ge_8 hm m3 (Machine.accu s :: v0 :: v1 :: v2 :: rest) sp_b new_sp_ofs).
        apply (stack_repr_store_other_block hm m2 m3
                 (Machine.accu s :: v0 :: v1 :: v2 :: rest) sp_b new_sp_ofs sb
                 (uso + 8) cxb2
                 Hstack_m2 Hstore_accu_field).
