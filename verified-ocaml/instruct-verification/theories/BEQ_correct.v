...
Proof.
  ...
  (* ================================================================ *)
  {
    ...
    { apply Z.eqb_eq in Heqb. subst a. simpl.
      ...
      destruct interp_state_co_beq as [co_is [Hco [Hpc_offset Haccu_offset]]].
      ...
      set (le' := PTree.set _t'7 (Vint ofs_int) (PTree.set _t'6 (Vptr cb pc1) (PTree.set _t'5 (Vptr cb pc1)
                    (PTree.set _t'3 (Vlong (Int64.repr (n * 2 + 1))) (PTree.set _t'2 (Vint (Int.repr n))
              ...
              { (* Sifthenelse: comparison true => then branch *)
                ...
                { (* Eval condition *)
                  ...
                  - eapply eval_Ecast.
                    ...
                    + apply sem_cast_long_vlong.
                  - apply (beq_cmp_eq n m1 Haccu_range Hn_range). }
                ...
                { eapply eval_Ebinop.
                  ...
                  - eapply eval_Ecast.
                    + eapply eval_Ebinop.
                      ...
                      * apply sem_shr_long_int_1.
                    + apply sem_cast_long_vlong.
                  - apply (beq_cmp_neq a n m1 Haccu_range Hn_range Heqb). }
                { apply bool_val_of_bool. }
                { simpl.
