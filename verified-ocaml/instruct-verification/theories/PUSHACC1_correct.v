...
Proof.
  ...
  destruct (store_succeeds_from_load m2 sb (Ptrofs.unsigned so + 8) accu_v cv0
  ...
  (* ============================================================== *)
  {
    ...
    try rewrite (sem_cast_long_val_repr _ _ _ _ Hval_repr0); eval_cbn.
  ...
  (* ============================================================== *)
  {
    ...
    { pose proof (load_after_store_same m2 m3 sb (uso + 8) cv0 Hstore_accu_field) as Htmp.
      rewrite (val_repr_load_result hm v0 cv0 Hval_repr0) in Htmp.
      exact Htmp. }
