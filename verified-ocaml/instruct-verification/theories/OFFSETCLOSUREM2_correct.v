...
(* ================================================================== *)
(* Precondition: closure env is representable as Vlong with valid sub   *)
(* ================================================================== *)

Definition offsetclosurem2_pre
  ...
  - simpl.
    {
      ...
      unfold offsetclosurem2_pre in Hstep_pre.
