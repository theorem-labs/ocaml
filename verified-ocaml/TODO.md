...
- [/] symlink the test-suite of system-ocaml and test bytecode interpreter against ocamlrun on everything in the ocaml compiler test-suite (infra done, 10/39 pass on basic/, most failures are GETFIELD interpreter limitation)
